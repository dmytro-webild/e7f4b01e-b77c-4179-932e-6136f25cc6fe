  ...
  return (
    ...
    >
      ...
      <div id="contact" data-section="contact">
        <ContactText
          text="Ready to organize your notes? Join thousands of users who trust NoteHub with their important information. Start your free trial today—no credit card required."
